# https://github.com/luanshiyinyang/DenseNet

from tensorflow import keras
from tensorflow.keras.models import Model
from tensorflow.keras.layers import BatchNormalization, Conv2D, Activation, Dropout, AveragePooling2D, concatenate, GlobalAveragePooling2D, MaxPooling2D, Dense, Input
...
if __name__ == '__main__':
    densenet = DenseNet(4, (40, 32, 1))
    keras.utils.plot_model(densenet, 'densenet.png', show_shapes=True)
